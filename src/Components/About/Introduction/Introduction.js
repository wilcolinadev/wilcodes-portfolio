  ...
  return (
    <Grid container sx={{  padding:{ xs: '2rem', lg: '5rem'} }} justifyContent={'center'}>
      ...
      <div >
        ...
        <Description>
          I'm Wilfredo, a <span style={{fontWeight: 'bolder', fontStyle: 'italic'}}> Web Developer</span> who loves to face new challenges every day. My passion about translating designs
    ...
    <Grid item xs={12} md={4} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <AboutImage src={'https://res.cloudinary.com/djf9jqpml/image/upload/v1711674129/wilcodes/assets/undraw_developer_f55kfw.svg'} alt={'Web developer'} />
    </Grid>
