...
const Bio = () => {
  return (
    <Grid
     ...
     sx={{ margin: '0 auto', padding: { xs: '2rem', lg: '5rem' }, backgroundColor: 'rgba(255, 255, 255, 0.7)', borderTop: '2px solid #3f3d55' }}
    >
      ...
      >
        <Grid item xs={12} md={8}>
          <div>
            ...
            <Description>
              As a proficient in Adobe Photoshop and Figma, I seamlessly merge design with functionality. With a sharp
              eye for detail and strong organizational skills, I've effectively managed projects and led teams in my
              current role.
            </Description>
            <Description>
              At Gaido's Seaside Inn and StayGalveston, I've played a pivotal role in web development and SEO
              strategies, driving substantial growth in online traffic and bookings.
            </Description>
            <Description>
